...
onready var red_obstacle = $Obstacles/RedObstacle
...
func _ready():
	...
	red_obstacle.connect("body_entered", self, "_on_red_body_enter")
	#red_obstacle.connect("ready", self, "_on_red_body_enter")
	#mobile
	#if Global.is_mobile():
